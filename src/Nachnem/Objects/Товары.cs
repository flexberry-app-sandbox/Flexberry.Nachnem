...
namespace IIS.Nachnem
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Nachnem.ЕдИзм fЕдиницыИзмер;
        ...
        public virtual IIS.Nachnem.ЕдИзм ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Nachnem.ЕдИзм result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Nachnem.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Nachnem.Товары));
                }
            }
        }
    }
