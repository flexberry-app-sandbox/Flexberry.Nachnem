...
namespace IIS.Nachnem
{
    ...
    public class Организация : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Nachnem.Сотрудники fСотрудники;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Nachnem.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Nachnem.Сотрудники result = this.fСотрудники;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОрганизацияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОрганизацияE", typeof(IIS.Nachnem.Организация));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОрганизацияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОрганизацияL", typeof(IIS.Nachnem.Организация));
                }
            }
        }
    }
