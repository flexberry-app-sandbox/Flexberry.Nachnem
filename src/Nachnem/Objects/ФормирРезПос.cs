...
namespace IIS.Nachnem
{
    ...
    [View("ФормирРезПосE", new string[] {
            ...
            "ФормирДокРаспр.ДокумПоставки.Организация.НаимОрганиз as \'Наименование организации" +
                "\'"})]
    ...
    [View("ФормирРезПосL", new string[] {
            ...
            "УдовлКлиента as \'Удовлетворенность клиента\'",
            "ФормирДокРаспр as \'Номер документа распределения\'"})]
    [MasterViewDefineAttribute("ФормирРезПосL", "ФормирДокРаспр", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "НомерДокРаспр")]
