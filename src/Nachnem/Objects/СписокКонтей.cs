...
namespace IIS.Nachnem
{
    ...
    public class СписокКонтей : ICSSoft.STORMNET.DataObject
    {
        ...
        [StrLen(255)]
        public virtual string НомерКонтей
        {
            get
            {
                ...
                string result = this.fНомерКонтей;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СписокКонтейE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СписокКонтейE", typeof(IIS.Nachnem.СписокКонтей));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СписокКонтейL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СписокКонтейL", typeof(IIS.Nachnem.СписокКонтей));
                }
            }
        }
    }
